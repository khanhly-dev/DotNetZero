...
export class CityServiceProxy {
    ...
    protected processGetAllCity(response: HttpResponseBase): Observable<CityDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class VietTestServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    myFunction(body: MyInputDto | undefined): Observable<MyOutputDto> {
        let url_ = this.baseUrl + "/api/services/app/VietTest/MyFunction";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processMyFunction(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processMyFunction(<any>response_);
                } catch (e) {
                    return <Observable<MyOutputDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<MyOutputDto>><any>_observableThrow(response_);
        }));
    }

    protected processMyFunction(response: HttpResponseBase): Observable<MyOutputDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MyOutputDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<MyOutputDto>(<any>null);
    }
}
...
export class MyInputDto implements IMyInputDto {
    myProperty1: number;
    myProperty2: number;

    constructor(data?: IMyInputDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.myProperty1 = _data["myProperty1"];
            this.myProperty2 = _data["myProperty2"];
        }
    }

    static fromJS(data: any): MyInputDto {
        data = typeof data === 'object' ? data : {};
        let result = new MyInputDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["myProperty1"] = this.myProperty1;
...
export interface IMyInputDto {
    myProperty1: number;
    myProperty2: number;
}

export class MyOutputDto implements IMyOutputDto {
    myProperty1: number;
    myProperty2: number;

    constructor(data?: IMyOutputDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MyOutputDto {
        data = typeof data === 'object' ? data : {};
        let result = new MyOutputDto();
        result.init(data);
        return result;
    }
